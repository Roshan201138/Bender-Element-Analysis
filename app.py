...
SETUP_IMAGE_CANDIDATES = [
    "be_setup.png",
    "bender_element_setup.png",
    "setup.png",
    "be_setup.jpg",
    "bender_element_setup.jpg",
    "setup.jpg",
    "be_setup.jpeg",
    "bender_element_setup.jpeg",
    "setup.jpeg",
]
...
def find_setup_image_file() -> Optional[str]:
    return find_first_existing_file(SETUP_IMAGE_CANDIDATES)
...
st.markdown(
    "This app reads bender element CSV, Excel, and text files and estimates the shear wave velocity and small-strain shear modulus using peak-to-peak and cross-correlation."
)
...
with meta1:
    ...
    travel_length_mm = st.number_input("Travel length L (mm)", min_value=0.001, value=50.0, step=1.0, format="%.6f")
with meta2:
    density_kg_m3 = st.number_input("Bulk density ρ (kg/m³)", min_value=0.001, value=2000.0, step=10.0, format="%.6f")
